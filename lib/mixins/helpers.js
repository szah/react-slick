...
var helpers = {
  ...
  getActiveImageHeight: function getActiveImageHeight() {
    if (this.refs.list) {
      return this.getCurrentSlideImg().getBoundingClientRect().height || this.getCurrentSlideImg().naturalHeight || this.getCurrentSlide().getBoundingClientRect().height;
    }
    return 0;
  },
  getActiveImageWidth: function getActiveImageWidth() {
    if (this.refs.list) {
      return this.getCurrentSlideImg().getBoundingClientRect().width || this.getCurrentSlideImg().naturalWidth || this.getCurrentSlide().getBoundingClientRect().width;
    }
    return 0;
  },
  ...
  autoPlay: function autoPlay() {
    ...
    var play = function play() {
      if (_this3.state.mounted) {
        var maybeTarget = _this3.state.currentSlide + _this3.props.slidesToScroll;
        var nextIndex = _this3.props.rtl ? _this3.state.currentSlide - _this3.props.slidesToScroll : maybeTarget >= _this3.state.slideCount ? 0 : maybeTarget;

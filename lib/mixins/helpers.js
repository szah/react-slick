...
var _lodash = require('lodash.delay');
...
var helpers = {
  initialize: function initialize(props) {
    if (this.getActiveImageWidth() === 0) {
      (0, _lodash2.default)(this.update.bind(this, props), 500);
    }
  ...
  isImagesLoaded: function isImagesLoaded(containerElem) {
    return nodeListToArray(getNestedImages(containerElem)).every(function (el) {
      return el.complete;
    });
  },
  ...
  onImageLoad: function onImageLoad(callback) {
    if (!this.isImagesLoaded(this)) {
      return (0, _lodash2.default)(this.onImageLoad.bind(this, callback), 300);
    }
  ...
  adaptHeight: function adaptHeight() {
    if (this.getActiveImageHeight() === 0) {
      return (0, _lodash2.default)(this.adaptHeight, 150);
    }
  ...
  slideHandler: function slideHandler(index) {
    ...
    if (this.props.useCSS === false) {
      ...
      _callback = function callback() {
        var timeOffset = +new Date() - _this.date;
        if (timeOffset < _this.props.speed - 100) {
          if (_this.props.devMode === true) {
            console.warn('react-slick: animation is was interrupted: should be ' + _this.props.speed + ', but was ' + timeOffset);
          }
          return false;
        }
